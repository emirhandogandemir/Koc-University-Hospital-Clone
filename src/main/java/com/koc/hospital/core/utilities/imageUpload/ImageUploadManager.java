...
import com.koc.hospital.core.utilities.results.ErrorDataResult;
...
public class ImageUploadManager implements ImageUploadService {
	...
	public ImageUploadManager() {
		...
		this.cloudinary = new Cloudinary(ObjectUtils.asMap("cloud_name", "dlkz9szh8", "api_key", "386916385284692",
